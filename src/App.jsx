        ...
        <section id="pipeline" className="py-20 md:py-28 border-b border-slate-900 bg-slate-900/10">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-start">
              <div className="lg:col-span-4 flex flex-col gap-3" role="tablist">
                {[
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
              <div className="bg-slate-900/30 border border-slate-900 rounded-2xl p-8 relative">
                ...
                <Layers className="w-8 h-8 text-cyan-500 mb-6 mt-2" aria-hidden="true" />
              ...
              <div className="bg-slate-900/30 border border-slate-900 rounded-2xl p-8 relative">
                ...
                <Cpu className="w-8 h-8 text-blue-500 mb-6 mt-2" aria-hidden="true" />
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800/60 flex flex-col justify-between">
                <div>
                  <Building className="w-7 h-7 text-cyan-400 mb-6" aria-hidden="true" />
              ...
              <div className="bg-slate-900 p-8 rounded-2xl border border-slate-800/60 flex flex-col justify-between">
                <div>
                  <Clapperboard className="w-7 h-7 text-indigo-400 mb-6" aria-hidden="true" />
                ...
                <div className="grid sm:grid-cols-2 gap-8 text-xs">
                  <div>
                    <h4 className="font-bold text-white mb-2 flex items-center gap-2">
                      <Lock className="w-4 h-4 text-cyan-400" aria-hidden="true" /> Full Encryption
                    </h4>
